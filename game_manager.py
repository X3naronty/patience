...
HELP_MESSAGE = '''
To jest instrukcja gry, pisz polecenia przestrzegając wcięć i znaków
...
class GameManager(CLI):
    ...
    def create_game(self) -> int:
        ...
        player_input = input(self.bg + 'Wpisz poziom trudności: "hard" czy "light"\n')
